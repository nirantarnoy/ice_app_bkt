...
class PrintBluetoothPage extends StatefulWidget {
  @override
  _PrintBluetoothPageState createState() => _PrintBluetoothPageState();
}

class _PrintBluetoothPageState extends State<PrintBluetoothPage> {
